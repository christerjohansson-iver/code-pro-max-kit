...
Pull the latest agent harness improvements from the remote code-pro-max-kit repository into the current project.
...
git clone --depth 1 https://github.com/christerjohansson-iver/code-pro-max-kit.git "$TMPDIR"
```
