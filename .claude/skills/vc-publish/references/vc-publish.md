...
```json
{
  "kitRepoPath": "/Users/you/code-pro-max-kit"
}
```

- The path must point to a git checkout of `github.com/christerjohansson-iver/code-pro-max-kit.git`
...
Published to: github.com/christerjohansson-iver/code-pro-max-kit.git
Tag: v2.2.0
Commit: abc1234
