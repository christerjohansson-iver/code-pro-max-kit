...
Push harness improvements from the current development repo to the remote kit repository (`code-pro-max-kit`). This is the **maintainer** counterpart to `vc-update`.
...
- Local checkout of the kit repo (`git clone git@github.com:christerjohansson-iver/code-pro-max-kit.git`)
...
```json
{"kitRepoPath": "/path/to/code-pro-max-kit"}
```
...
Files changed: 4
Remote:        git@github.com:christerjohansson-iver/code-pro-max-kit.git
Tag:           v2.2.0
