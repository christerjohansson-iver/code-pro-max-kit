...
# code-pro-max-kit 기여 가이드

code-pro-max-kit에 관심을 가져주셔서 감사해요! 이 프로젝트는 Claude Code와 Codex를 위한 즉시 사용 가능한 에이전트 harness를 제공하며, 모든 분의 기여를 환영해요.
...
code-pro-max-kit을 모두를 위해 더 좋게 만드는 데 도움을 주셔서 감사해요!
