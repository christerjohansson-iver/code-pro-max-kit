...
# Đóng góp cho code-pro-max-kit

Cảm ơn bạn đã quan tâm đến việc đóng góp cho code-pro-max-kit! Project này cung cấp một agent harness sẵn dùng cho Claude Code và Codex, và chúng tôi hoan nghênh contributions từ mọi người.
...
Cảm ơn bạn đã giúp code-pro-max-kit tốt hơn cho mọi người!
