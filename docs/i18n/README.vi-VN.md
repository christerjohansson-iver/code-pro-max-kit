...
*Được xây dựng bởi những kỹ sư hàng đầu, dành cho developers tại*<br>
...
- **Đã có `.claude/` config?** Backup vào `.cpm-backup/`, cài mới, khôi phục `settings.json` của bạn
- **Đã có thư mục `process/`?** Không bao giờ bị đụng bởi install — `vc-setup` handle migration thông minh
- **Đã có `CLAUDE.md`?** Backup thành `CLAUDE.md.pre-cpm`, cài version harness mới
...
| Tính năng | code-pro-max-kit | Superpowers | GSD | gstack |
|---------|---------------------|-------------|-----|--------|
...
- 🐛 [Báo bug](https://github.com/christerjohansson-iver/code-pro-max-kit/issues/new?template=1.bug_report.yml)
- 💡 [Yêu cầu feature](https://github.com/christerjohansson-iver/code-pro-max-kit/issues/new?template=2.feature_request.yml)
- ⚡ [Submit skill](https://github.com/christerjohansson-iver/code-pro-max-kit/issues/new?template=3.skill_submission.yml)
- 🌐 [Thêm bản dịch](https://github.com/christerjohansson-iver/code-pro-max-kit/issues/new?template=5.translation.yml)
...
Điểm khác biệt: code-pro-max-kit tập trung vào framework phát triển theo spec và tổ chức context tự cải tiến, không phình to với 80+ skill. Ít công cụ hơn, nhiều cấu trúc hơn.
