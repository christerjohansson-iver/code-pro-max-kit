...
*Feito por engenheiros de classe mundial, para developers na*<br>
...
<p>
  <a href="https://github.com/christerjohansson-iver/code-pro-max-kit/stargazers"><img src="https://img.shields.io/github/stars/christerjohansson-iver/code-pro-max-kit" alt="Stars"></a>
  <a href="https://github.com/christerjohansson-iver/code-pro-max-kit/network/members"><img src="https://img.shields.io/github/forks/christerjohansson-iver/code-pro-max-kit" alt="Forks"></a>
  <a href="LICENSE"><img src="https://img.shields.io/github/license/christerjohansson-iver/code-pro-max-kit" alt="License"></a>
  <a href="https://github.com/christerjohansson-iver/code-pro-max-kit/graphs/contributors"><img src="https://img.shields.io/github/contributors/christerjohansson-iver/code-pro-max-kit" alt="Contributors"></a>
  <a href="https://github.com/christerjohansson-iver/code-pro-max-kit/actions/workflows/validate.yml"><img src="https://img.shields.io/github/actions/workflow/status/christerjohansson-iver/code-pro-max-kit/validate.yml" alt="CI"></a>
  <a href="https://github.com/christerjohansson-iver/code-pro-max-kit/commits/main"><img src="https://img.shields.io/github/last-commit/christerjohansson-iver/code-pro-max-kit" alt="Last Commit"></a>
...
```bash
curl -fsSL https://raw.githubusercontent.com/christerjohansson-iver/code-pro-max-kit/main/install.sh | bash
```
...
- **Ja tem `.claude/` configurado?** Faz backup em `.cpm-backup/`, instala do zero, restaura seu `settings.json`
- **Ja tem diretorio `process/`?** Nunca e tocado pelo install — o `vc-setup` cuida da migracao de forma inteligente
- **Ja tem `CLAUDE.md`?** Faz backup como `CLAUDE.md.pre-cpm`, instala a versao do harness
...
```
First, install the code-pro-max-kit agent harness by running this command:
...
| Funcionalidade | code-pro-max-kit | Superpowers | GSD | gstack |
|---------|---------------------|-------------|-----|--------|
...
- 🐛 [Reportar um bug](https://github.com/christerjohansson-iver/code-pro-max-kit/issues/new?template=1.bug_report.yml)
- 💡 [Solicitar uma feature](https://github.com/christerjohansson-iver/code-pro-max-kit/issues/new?template=2.feature_request.yml)
- ⚡ [Enviar uma skill](https://github.com/christerjohansson-iver/code-pro-max-kit/issues/new?template=3.skill_submission.yml)
- 🌐 [Adicionar uma traducao](https://github.com/christerjohansson-iver/code-pro-max-kit/issues/new?template=5.translation.yml)

<br>

<a href="https://github.com/christerjohansson-iver/code-pro-max-kit/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=christerjohansson-iver/code-pro-max-kit" alt="Contributors" />
</a>
...
A diferença: code-pro-max-kit foca no framework de desenvolvimento spec-driven e organização de contexto auto-aprimorável, sem inchar com 80+ skills. Menos ferramentas, mais estrutura.

---

## ⭐ Star History

<a href="https://star-history.com/#christerjohansson-iver/code-pro-max-kit&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=christerjohansson-iver/code-pro-max-kit&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=christerjohansson-iver/code-pro-max-kit&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=christerjohansson-iver/code-pro-max-kit&type=Date" />
 </picture>
</a>
