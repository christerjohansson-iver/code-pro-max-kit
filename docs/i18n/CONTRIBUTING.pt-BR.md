...
# Contribuindo para o code-pro-max-kit

Obrigado pelo interesse em contribuir com o code-pro-max-kit! Esse projeto oferece um harness de agente pronto pra uso para Claude Code e Codex, e contribuições de todo mundo são bem-vindas.
...
2. **Clone** seu fork localmente:
   ...
   ```bash
   git clone https://github.com/<your-username>/code-pro-max-kit.git
   cd code-pro-max-kit
   ```
...
3. **Instale** o harness em um projeto de teste pra verificar que tudo funciona:
   ...
   bash /path/to/code-pro-max-kit/install.sh
   ```
...
Obrigado por ajudar a tornar o code-pro-max-kit melhor pra todo mundo!