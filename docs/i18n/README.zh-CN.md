...
- **已有 `.claude/` 配置？** 备份到 `.cpm-backup/`，全新安装，恢复你的 `settings.json`
- **已有 `process/` 目录？** install 完全不碰——`vc-setup` 会智能迁移
- **已有 `CLAUDE.md`？** 备份为 `CLAUDE.md.pre-cpm`，安装 harness 版本
...
| 功能 | code-pro-max-kit | Superpowers | GSD | gstack |
|---------|---------------------|-------------|-----|--------|
...
- 🐛 [报告 Bug](https://github.com/christerjohansson-iver/code-pro-max-kit/issues/new?template=1.bug_report.yml)
- 💡 [功能请求](https://github.com/christerjohansson-iver/code-pro-max-kit/issues/new?template=2.feature_request.yml)
- ⚡ [提交 Skill](https://github.com/christerjohansson-iver/code-pro-max-kit/issues/new?template=3.skill_submission.yml)
- 🌐 [添加翻译](https://github.com/christerjohansson-iver/code-pro-max-kit/issues/new?template=5.translation.yml)
...
区别在于：code-pro-max-kit 专注于规格驱动的开发框架和自我改进的上下文组织，不会用 80+ 个技能让你应接不暇。更少工具，更多结构。
